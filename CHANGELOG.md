...
- Fixed interface designs of DanceBuilder.

## 2025.12.08

### Updated

- Fixed brainstorming designs of DanceBuilder, Food, and TechTickets.
...
- Designed kernel implementation for DanceBuilder component
...
- Designed kernel and enhanced interfaces for generateType(), numBars(), danceMood(), choreography()
